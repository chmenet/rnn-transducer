...
def sequence_to_text(sequence, cleaner_names=["korean_cleaners"]):
...
if __name__ == "__main__":
  ...
  print(sequence_to_text(text_to_sequence('테스트 문장입니다.? ', ['korean_cleaners'])))
